...
},{"prefixed":2}],2:[function(require,module,exports){
/**
 * Supported prefixes.
 */
...
addChatMessage = function(nick, message, data) {
	...
	//해당 객체를 기억해 두었다가 존재할 때에만 제거하도록 수정.
	var fade = require('fade');

	if (fadeoutTime != 0) {
			setTimeout(function () {
					var targetObject = chatOuterBox;
					if (targetObject != null) {
						targetObject.style.opacity = "1";
							fade(targetObject, 0, configData.msgAniDuration * 1000, function(){
								chatOuterBox.remove(targetObject);
								--numChat;
							});
					}
			}, fadeoutTime);
...
var checkComplete = function() {
	...
	if (++completeCount == num) {
		var chat = addChatMessage("",
			'<center><p>Powered by mr_watert:<br/>'+
			'Modified by SemiR4in<br/>'+
			'<br/><i>JawsBridgeBBCC v' + configData.versionText+'</i><br/>'+
			'<div style="' +
			"display:inline-block; white-space:pre; line-height:1em; " +
			"color:white; background:black; font-weight: 400; font-size: 12pt; font-family:'굴림체'; " + 
...
},{"./twip_apply.js":4,"fade":1}],4:[function(require,module,exports){
var twipMsg =
